...
<?php foreach( $bundlez_options as $key => $bundlez_option ) { ?>
     <table class="bundlez-form-table form-table">
        ...
        <tr valign="top">
            ...
            <td>
                <?php echo $bundlez_option['bundle_membership']['membership_title']; ?>
            </td>
            <th scope="row"></th>
            <td></td>
...
<form method="post" action="<?php echo admin_url( 'admin-post.php' ); ?>">
    ...
    <table class="bundlez-form-table form-table">
        ...
        <tr valign="top">
            <th scope="row">Bundlez Membership</th>
            <td>
                <select class="bundlez-form-input" id="bundle_membership_id" name="bundlez[bundle_membership]" >
                    <option value="" ></option>
        ...
        <tr valign="top">
            <th scope="row">Conquer Maths Membership</th>
            <td>
                <select class="bundlez-form-input" id="cm_membership_id" name="bundlez[cm][membership]">
                    <option value=""></option>
                    <?php
            ...
            <th scope="row">Value</th>
            <td><input class="bundlez-form-input" type="number" min="0" id="cm_membership_amount" name="bundlez[cm][membership_amount]" value="" placeholder="Enter an amount" /></td>
        
        </tr>  
        <tr valign="top">
            <th scope="row">Conquer Computing Membership</th>
            <td>
                <select class="bundlez-form-input" id="cc_membership_id" name="bundlez[cc][membership]">
                    <option value=""></option>
                    <?php
            ...
            <th scope="row">Value</th>
            <td><input class="bundlez-form-input" type="number" min="0" id="cc_membership_amount" name="bundlez[cc][membership_amount]" value="" placeholder="Enter an amount" /></td>
